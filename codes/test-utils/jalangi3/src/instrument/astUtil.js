...
//            if (object.hasOwnProperty(key)) {
			...
			// added ES6 capacity
			(type === 'ForOfStatement' && key === 'left') ||
			// end mod
                        ((type === 'FunctionExpression' || type === 'FunctionDeclaration' ||
			type === 'ArrowFunctionExpression') && key === 'id') ||
			...
			// added ES6 capacity
			(type === 'AssignmentPattern' && key === 'left') || 
			(type === 'RestElement' && key === 'argument') ||
		        (type === 'ClassDeclaration' && key === 'id') ||
			(type === 'ClassExpression' && key === 'id') ||
			(type === 'ImportDeclaration' && key === 'specifiers') ||
			(type === 'ExportNamedDeclaration' && key === 'specifiers') ||
			(type === 'ImportSpecifier' && (key === 'imported' || key === 'local')) ||
			(type === 'Property' && !object.computed && key === 'key')
			// end mod
		    ) {
		       ...
		       || type === 'ArrowFunctionExpression') && key === 'params') {
